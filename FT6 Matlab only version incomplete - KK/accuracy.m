...
% METHOD: Solve for the average depth distance across the ROI depth data. Apply test to each of at least 50 frames and report the largest difference from the actual distance as calculated across all 50 frames. 
